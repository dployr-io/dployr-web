...
import { ArrowUpRightIcon, BoxesIcon, ChevronLeft, ChevronRight, CirclePlus } from "lucide-react";
...
function Services() {
  ...
  const totalPages = Math.max(1, Math.ceil(servicesArray.length / itemsPerPage));
                          ...
                          >
                            ...
                            <TableCell className="h-16 align-middle">
                              <div className="flex items-center gap-2">
                                ...
                                <span>{service.runtime_version}</span>
                              </div>
                            </TableCell>
