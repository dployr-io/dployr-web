            ...
            <AppLayout breadcrumbs={breadcrumbs}>
                <SettingsLayout>
                        ...
                        >
                            <div className="flex w-full justify-between align-middle">
                                <TabsList className="grid grid-cols-3 w-[400px]">
                                    ...
                                    <TabsTrigger value="invites-received">
                                        Invites Received
                                    </TabsTrigger>
                                    <TabsTrigger value="invites-sent">
                                        Invites Sent
                                    </TabsTrigger>
                                </TabsList>
                                    ...
                                    <TableBody>
                                        {isLoadingInvitesReceived
                                            ...
                                            : invitesReceived && invitesReceived.length > 0
                                              ? invitesReceived.map(
                                                    (invite: { clusterId: string; clusterName: string; ownerName: string; ownerEmail?: string }) => (
                                                        <TableRow key={invite.clusterId}>
                                                            <TableCell className="font-medium">
                                                                {invite.clusterName}
                                                            </TableCell>
                                                            <TableCell>
                                    ...
                                    <TableBody>
                                        {isLoadingInvitesSent
                                            ...
                                            : invitesSent && invitesSent.length > 0
                                              ? invitesSent.map((invite: { clusterId: string; clusterName: string; ownerName: string; recipientEmail?: string; invitedAt?: string; status?: string }) => (
                                                    <TableRow key={invite.clusterId}>
                                                        <TableCell className="font-medium">
                                                            {invite.clusterName}
                                                        </TableCell>
                                                        <TableCell>
                                                            <span className="text-sm text-neutral-600">
                                                                {invite.recipientEmail || invite.ownerName}
                                                            </span>
                                                        </TableCell>
                                                        <TableCell>
                                                            <span className="text-sm text-neutral-600">
                                                            ...
                                                            <span
                                                                className={`inline-block rounded-full px-2 py-0.5 text-xs font-semibold backdrop-blur-md border shadow-sm ${(() => {
                                                                    ...
                                                                    invite.status
                                                                        ...
                                                                        case "accepted":
                                                                            return "bg-green-950/30 text-green-950 border-green-800/50 dark:bg-green-900/35 dark:text-green-100 dark:border-green-700/60 shadow-green-950/20";
                                                                        case "declined":
                                                                            return "bg-red-950/30 text-red-950 border-red-800/50 dark:bg-red-900/35 dark:text-red-100 dark:border-red-700/60 shadow-red-950/20";
                                                                        case "pending":
                                                                        default:
                                                                            return "bg-yellow-950/30 text-yellow-950 border-yellow-800/50 dark:bg-yellow-900/35 dark:text-yellow-100 dark:border-yellow-700/60 shadow-yellow-950/20";
                                                                    }
                                                                })()}`}
                                                            >
                                                                {invite.status
                                                                ...
                                                                {invite.status ===
                                                                    ...
                                                                    <>
                                                                        <Button
                                                                            ...
                                                                            onClick={() => {
                                                                                alert(
                                                                                    `Reminder sent to ${invite.recipientEmail || invite.ownerName}!`,
                                                                                );
                                                                            }}
                                                                            className="h-8 px-3 cursor-pointer"
                                                                        ...
                                                                        <Button
                                                                            ...
                                                                            onClick={() => {
                                                                                alert(
                                                                                    `Cancelled invite for ${invite.recipientEmail || invite.ownerName}!`,
                                                                                );
                                                                            }}
                                                                            className="h-8 px-3 hover:bg-red-500 cursor-pointer"
                    ...
                    <InviteUserDialog
                        ...
                        onOpenChange={handleInviteUsersDialogClose}
                        handleSubmit={addUsersForm.handleSubmit}
                    />

                    {/* Activity Modal */}
                    <ActivityModal
                        open={usersUrlState.activityModal.open}
